...
class TestGatttool(unittest.TestCase):
    ...
    @mock.patch('cutecare.backends.gatttool.Popen')
    ...
    @mock.patch('cutecare.backends.gatttool.call', return_value=None)
    def test_check_backend_ok(self, call_mock):
        """Test check_backend successfully."""
        be = GatttoolBackend()
        be.check_backend()

    @mock.patch('cutecare.backends.gatttool.call', **{'side_effect': IOError()})
